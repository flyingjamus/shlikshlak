...
if (__DEV__) {
  ...
  ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = (fiber: Fiber, instance: any) => {
  ...
  ReactStrictModeWarnings.recordLegacyContextWarning = (fiber: Fiber, instance: any) => {
  ...
  ReactStrictModeWarnings.flushLegacyContextWarning = () => {
    ((pendingLegacyContextWarning as any) as FiberToFiberComponentsMap).forEach((fiberArray: FiberArray, strictRoot) => {
