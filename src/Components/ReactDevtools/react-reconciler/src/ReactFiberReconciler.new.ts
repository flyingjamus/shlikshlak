import type { Fiber, SuspenseHydrationCallbacks, TransitionTracingCallbacks } from "./ReactInternalTypes";
...
export function createHydrationContainer(initialChildren: ReactNodeList, // TODO: Remove `callback` when we delete legacy mode.
callback: ((...args: Array<any>) => any) | null | undefined, containerInfo: Container, tag: RootTag, hydrationCallbacks: null | SuspenseHydrationCallbacks, isStrictMode: boolean, concurrentUpdatesByDefaultOverride: null | boolean, identifierPrefix: string, onRecoverableError: (error: unknown) => void, transitionCallbacks: null | TransitionTracingCallbacks): OpaqueRoot {
  const hydrate = true;
...
export function updateContainer(element: ReactNodeList, container: OpaqueRoot, parentComponent: React.Component<any, any> | null | undefined, callback: ((...args: Array<any>) => any) | null | undefined): Lane {
  if (__DEV__) {
