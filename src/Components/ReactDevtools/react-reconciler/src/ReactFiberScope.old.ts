...
import type { ReactScopeInstance, ReactContext, ReactScopeQuery } from "shared/ReactTypes";
...
function DO_NOT_USE_queryAllNodes(fn: ReactScopeQuery): null | Array<Record<string, any>> {
...
function DO_NOT_USE_queryFirstNode(fn: ReactScopeQuery): null | Record<string, any> {
  const currentFiber = getInstanceFromScope(this);
...
function containsNode(node: Record<string, any>): boolean {
