...
export function findAllNodes(hostRoot: Instance, selectors: Array<Selector>): Array<Instance> {
...
export function findBoundingRects(hostRoot: Instance, selectors: Array<Selector>): Array<BoundingRect> {
  if (!supportsTestSelectors) {
    throw new Error('Test selector API is not supported by this renderer.');
  }
