...
export function getWorkInProgressVersion(mutableSource: MutableSource<any>): null | MutableSourceVersion {
  if (isPrimaryRenderer) {
...
export function setWorkInProgressVersion(mutableSource: MutableSource<any>, version: MutableSourceVersion): void {
  if (isPrimaryRenderer) {
...
export function warnAboutMultipleRenderersDEV(mutableSource: MutableSource<any>): void {
  if (__DEV__) {
    if (isPrimaryRenderer) {
...
export function registerMutableSourceForHydration(root: FiberRoot, mutableSource: MutableSource<any>): void {
