...
import type { FiberRoot, SuspenseHydrationCallbacks, TransitionTracingCallbacks } from "./ReactInternalTypes";
...
identifierPrefix: string, onRecoverableError: null | ((error: unknown) => void), transitionCallbacks: null | TransitionTracingCallbacks): FiberRoot {
  const root: FiberRoot = (new FiberRootNode(containerInfo, tag, hydrate, identifierPrefix, onRecoverableError) as any);
