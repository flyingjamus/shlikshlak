...
import type { OffscreenState, OffscreenInstance, OffscreenQueue } from "./ReactFiberOffscreenComponent";
import type { HookFlags } from "./ReactHookEffectTags";
import type { Cache } from "./ReactFiberCacheComponent.old";
import type { RootState } from "./ReactFiberRoot.old";
import type { Transition, TracingMarkerInstance, TransitionAbort } from "./ReactFiberTracingMarkerComponent.old";
...
function commitHookPassiveUnmountEffects(finishedWork: Fiber, nearestMountedAncestor, hookFlags: HookFlags) {
  if (shouldProfile(finishedWork)) {
    startPassiveEffectTimer();
