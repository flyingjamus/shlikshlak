...
function shouldAvoidedBoundaryCapture(workInProgress: Fiber, handlerOnStack: Fiber, props: any): boolean {
...
export function setShallowSuspenseListContext(parentContext: SuspenseContext, shallowContext: ShallowSuspenseContext): SuspenseContext {
