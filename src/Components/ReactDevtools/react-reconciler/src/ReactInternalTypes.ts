...
import type { RefObject, ReactContext, MutableSourceSubscribeFn, MutableSourceGetSnapshotFn, MutableSourceVersion, MutableSource, StartTransitionOptions, Wakeable, Usable } from "shared/ReactTypes";
...
// is implemented
import type { TracingMarkerInstance, Transition } from "./ReactFiberTracingMarkerComponent.new";
...
export type FiberRoot = BaseFiberRootProperties & SuspenseCallbackOnlyFiberRootProperties & UpdaterTrackingOnlyFiberRootProperties & TransitionTracingOnlyFiberRootProperties;
type BasicStateAction<S> = ((arg0: S) => S) | S;
type Dispatch<A> = (arg0: A) => void;
export type Dispatcher = {
  use?: <T>(arg0: Usable<T>) => T;
