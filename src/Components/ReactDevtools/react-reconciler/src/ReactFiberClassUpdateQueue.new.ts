...
export function commitHiddenCallbacks<State>(updateQueue: UpdateQueue<State>, context: any): void {
...
export function commitCallbacks<State>(updateQueue: UpdateQueue<State>, context: any): void {
