...
export opaque type Type = unknown; // eslint-disable-line no-undef

export opaque type Props = unknown; // eslint-disable-line no-undef

export opaque type Container = unknown; // eslint-disable-line no-undef

export opaque type Instance = unknown; // eslint-disable-line no-undef

export opaque type TextInstance = unknown; // eslint-disable-line no-undef

export opaque type SuspenseInstance = unknown; // eslint-disable-line no-undef

export opaque type HydratableInstance = unknown; // eslint-disable-line no-undef

export opaque type PublicInstance = unknown; // eslint-disable-line no-undef

export opaque type HostContext = unknown; // eslint-disable-line no-undef

export opaque type UpdatePayload = unknown; // eslint-disable-line no-undef

export opaque type ChildSet = unknown; // eslint-disable-line no-undef

export opaque type TimeoutHandle = unknown; // eslint-disable-line no-undef

export opaque type NoTimeout = unknown; // eslint-disable-line no-undef

export opaque type RendererInspectionConfig = unknown; // eslint-disable-line no-undef
...
export const getMatchingResourceInstance = $$$hostConfig.getMatchingResourceInstance;