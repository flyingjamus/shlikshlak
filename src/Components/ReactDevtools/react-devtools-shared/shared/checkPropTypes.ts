...
export default function checkPropTypes(typeSpecs: Record<string, any>, values: Record<string, any>, location: string, componentName: string | null | undefined, element?: any): void {
  if (__DEV__) {
