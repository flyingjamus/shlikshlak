...
import { DehydratedData } from './devtools/views/Components/types'
export const meta = {
...
export function dehydrate(
  ...
  | Record<string, string | Dehydrated | Unserializable> {
...
function upgradeUnserializable(destination: Record<string, any>, source: Record<string, any>) {
