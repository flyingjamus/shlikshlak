...
const assign = Object.assign // Note that the Overlay components are not affected by the active Theme,
...
class OverlayRect {
  ...
  update(box: Rect, dims: any) {
    ...
    assign(this.content.style, {
      height: box.height - dims.borderTop - dims.borderBottom + 'px',
      width: box.width - dims.borderLeft - dims.borderRight + 'px',
    })
    assign(this.node.style, {
...
export default class Overlay {
  ...
  inspect(nodes: Array<HTMLElement>, name?: string | null | undefined) {
