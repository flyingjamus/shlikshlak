...
export type ReactRenderer = {
  ...
  // 16.9+
  overrideHookState?: ((fiber: Record<string, any>, id: number, path: Array<string | number>, value: any) => void) | null | undefined;
  // 17+
  overrideHookStateDeletePath?: ((fiber: Record<string, any>, id: number, path: Array<string | number>) => void) | null | undefined;
  // 17+
  overrideHookStateRenamePath?: ((fiber: Record<string, any>, id: number, oldPath: Array<string | number>, newPath: Array<string | number>) => void) | null | undefined;
  // 16.7+
  overrideProps?: ((fiber: Record<string, any>, path: Array<string | number>, value: any) => void) | null | undefined;
  // 17+
  overridePropsDeletePath?: ((fiber: Record<string, any>, path: Array<string | number>) => void) | null | undefined;
  // 17+
  overridePropsRenamePath?: ((fiber: Record<string, any>, oldPath: Array<string | number>, newPath: Array<string | number>) => void) | null | undefined;
  // 16.9+
  ...
  setErrorHandler?: ((shouldError: (fiber: Record<string, any>) => boolean | null | undefined) => void) | null | undefined;
...
export type InspectedElementPayload = InspectElementError | InspectElementFullData | InspectElementHydratedPath | InspectElementNoChange | InspectElementNotFound;
...
export type RendererInterface = {
  ...
  inspectElement: (requestID: number, id: number, inspectedPaths: Record<string, any>, forceFullData: boolean) => InspectedElementPayload;
  logElementToConsole: (id: number) => void;
  overrideError: (id: number, forceError: boolean) => void;
  overrideSuspense: (id: number, forceFallback: boolean) => void;
  overrideValueAtPath: (type: Type, id: number, hook: number | null | undefined, path: Array<string | number>, value: any) => void;
  patchConsoleForStrictMode: () => void;
  prepareViewAttributeSource: (id: number, path: Array<string | number>) => void;
  prepareViewElementSource: (id: number) => void;
  renamePath: (type: Type, id: number, hookID: number | null | undefined, oldPath: Array<string | number>, newPath: Array<string | number>) => void;
...
export type DevToolsHook = {
  ...
  onCommitFiberRoot: (rendererID: RendererID, fiber: Record<string, any>, // Added in v16.9 to support Profiler priority labels
  commitPriority?: number, // Added in v16.9 to support Fast Refresh
  didError?: boolean) => void;
