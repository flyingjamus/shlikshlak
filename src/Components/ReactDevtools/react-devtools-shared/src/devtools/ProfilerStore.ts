...
import type { CommitDataFrontend, ProfilingDataForRootFrontend, ProfilingDataFrontend, SnapshotNode } from "./views/Profiler/types";
import { FrontendBridge } from '../bridge'
import { ProfilingDataBackend } from '../backend/types'
export default class ProfilerStore extends EventEmitter<{
  ...
  _takeProfilingSnapshotRecursive = (elementID: number, profilingSnapshots: Map<number, SnapshotNode>) => {
