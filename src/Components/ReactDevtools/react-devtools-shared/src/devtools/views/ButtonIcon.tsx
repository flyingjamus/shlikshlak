...
export type IconType = "add" | "cancel" | "clear" | "close" | "collapsed" | "copy" | "delete" | "down" | "editor" | "expanded" | "export" | "filter" | "import" | "log-data" | "more" | "next" | "parse-hook-names" | "previous" | "record" | "reload" | "save" | "search" | "settings" | "error" | "suspend" | "undo" | "up" | "view-dom" | "view-source";
type Props = {
  className?: string;
  type: IconType;
};
export default function ButtonIcon({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.ButtonIcon} ${className}`} width="24" height="24" viewBox="0 0 24 24">
      <path d="M0 0h24v24H0z" fill="none" />
      {typeof pathData === 'string' ? <path fill="currentColor" d={pathData} /> : pathData}
    </svg>;
}
...
`;
const PATH_ERROR = 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z';
const PATH_SUSPEND = `
