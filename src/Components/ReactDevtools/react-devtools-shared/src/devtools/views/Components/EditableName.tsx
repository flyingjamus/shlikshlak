...
type OverrideNameFn = (oldName: Array<string | number>, newName: Array<string | number>) => void;
...
export default function EditableName({
  ...
  return <AutoSizeInput autoFocus={autoFocus} className={[styles.Input, className].join(' ')} onChange={handleChange} onKeyDown={handleKeyDown} placeholder="new entry" testName="EditableName" type="text" value={editableName} />;
}
