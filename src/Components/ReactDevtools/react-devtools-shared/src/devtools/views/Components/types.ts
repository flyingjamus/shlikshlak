...
import type { Dehydrated, Unserializable } from "../../../hydration";
...
export type InspectedElementResponseType = "error" | "full-data" | "hydrated-path" | "no-change" | "not-found";
...
export type DehydratedData = {
  ...
  data: string | Dehydrated | Unserializable | Array<Dehydrated> | Array<Unserializable> | Record<string, string | Dehydrated | Unserializable>;
