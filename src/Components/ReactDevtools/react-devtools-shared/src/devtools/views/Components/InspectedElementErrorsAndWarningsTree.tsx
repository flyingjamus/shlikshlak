...
import styles from './InspectedElementErrorsAndWarningsTree.module.css'
...
export default function InspectedElementErrorsAndWarningsTree({ bridge, inspectedElement, store }: Props) {
  const refresh = useCacheRefresh()
  const [isErrorsTransitionPending, startClearErrorsTransition] = useTransition()
  ...
  const [isWarningsTransitionPending, startClearWarningsTransition] = useTransition()
...
function ErrorOrWarningView({ className, badgeClassName, count, message }: ErrorOrWarningViewProps) {
  return (
