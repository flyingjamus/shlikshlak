...
import UnsupportedBridgeOperationError from '../../../../src/UnsupportedBridgeOperationError'
import TimeoutError from '../../../../src/errors/TimeoutError'
import UserError from '../../../../src/errors/UserError'
import UnknownHookError from '../../../../src/errors/UnknownHookError'
...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  static getDerivedStateFromError(error: any) {
    const errorMessage =
      typeof error === 'object' && error !== null && typeof error.message === 'string' ? error.message : null
      ...
      if (isTimeout) {
        ...
        return (
          <CaughtErrorView
            ...
            info={
              <>
                React DevTools encountered an error while trying to inspect the hooks. This is most likely
                caused by a developer error in the currently inspected element. Please see your console for
                logged error.
              </>
            }
          />
        ...
        return (
          <CaughtErrorView
            ...
            info={
              <>
                React DevTools encountered an unknown hook. This is probably because the react-debug-tools
                package is out of date. To fix, upgrade the React DevTools to the most recent version.
              </>
            }
          />
        )
  ...
  _onStoreError = (error: Error) => {
    if (!this.state.hasError) {
      ...
      this.setState({ ...ErrorBoundary.getDerivedStateFromError(error), canDismiss: true })
    }
  }
}
