...
import HookNamesModuleLoaderContext from '../../../src/devtools/views/Components/HookNamesModuleLoaderContext'
...
import type { InspectedElement } from './Components/types'
import type { FetchFileWithCaching } from './Components/FetchFileWithCachingContext'
import type { HookNamesModuleLoaderFunction } from './Components/HookNamesModuleLoaderContext'
...
export type Props = {
  ...
  viewUrlSourceFunction?: ViewUrlSource | null | undefined
  readOnly?: boolean
...
export default function DevTools({
  ...
  const [currentTab, setTab] = useLocalStorage<TabID>(LOCAL_STORAGE_DEFAULT_TAB_KEY, defaultTab)
  let tab = currentTab
              ...
              >
                <ViewElementSourceContext.Provider value={viewElementSource}>
                  <ViewSourceContext.Provider value={viewSource}>
                    <HookNamesModuleLoaderContext.Provider value={hookNamesModuleLoaderFunction || null}>
                      <FetchFileWithCachingContext.Provider value={fetchFileWithCaching || null}>
