...
export type IconType = "arrow" | "bug" | "code" | "components" | "copy" | "error" | "facebook" | "flame-chart" | "profiler" | "ranked-chart" | "timeline" | "search" | "settings" | "store-as-global-variable" | "strict-mode-non-compliant" | "warning";
type Props = {
  className?: string;
  title?: string;
  type: IconType;
...
export default function Icon({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.Icon} ${className}`} width="24" height="24" viewBox="0 0 24 24">
