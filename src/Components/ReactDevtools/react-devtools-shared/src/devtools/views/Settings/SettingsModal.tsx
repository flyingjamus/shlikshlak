...
import { useLocalStorage, useModalDismissSignal, useSubscription } from "../hooks";
...
function SettingsModalImpl(_: {}) {
  ...
  const dismissModal = useCallback(() => setIsModalShowing(false), [setIsModalShowing]);
  const [selectedTabID, selectTab] = useLocalStorage<TabID>('React::DevTools::selectedSettingsTabID', 'general');
  ...
  return <div className={styles.Background}>
      <div className={styles.Modal} ref={modalRef}>
        <div className={styles.Tabs}>
          <TabBar currentTab={selectedTabID} id="Settings" selectTab={selectTab} tabs={tabs} type="settings" />
