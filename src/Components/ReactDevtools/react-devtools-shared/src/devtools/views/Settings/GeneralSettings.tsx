...
function getChangeLogUrl(version: string | null | undefined): string | null {
  if (!version) {
    return null;
  }
...
export default function GeneralSettings(_: {}) {
  ...
  return <div className={styles.Settings}>
      <div className={styles.Setting}>
        ...
        <select className={styles.Select} value={theme} onChange={({
        currentTarget
      ...
      <div className={styles.Setting}>
        ...
        <select className={styles.Select} value={displayDensity} onChange={({
        currentTarget
      ...
      {supportsTraceUpdates && <div className={styles.Setting}>
          <label>
            <input type="checkbox" checked={traceUpdatesEnabled} onChange={({
          currentTarget
      ...
      <div className={styles.ReleaseNotes}>
        {showBackendVersion && <div>
            <ul className={styles.VersionsList}>
              <li>
                <Version label="DevTools backend version:" version={backendVersion} />
              </li>
              <li>
                <Version label="DevTools frontend version:" version={frontendVersion} />
              </li>
            </ul>
          </div>}
        {!showBackendVersion && <Version label="DevTools version:" version={frontendVersion} />}
      </div>
    </div>;
}
...
function Version({
  ...
  if (version == null) {
    ...
    return <>
        {label}{' '}
        <a className={styles.ReleaseNotesLink} target="_blank" rel="noopener noreferrer" href={changelogLink}>
          {version}
        </a>
      </>;
  }
