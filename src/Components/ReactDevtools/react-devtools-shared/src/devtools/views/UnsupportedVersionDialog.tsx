...
import styles from "./UnsupportedVersionDialog.module.css";
      ...
      <div className={styles.Row}>
        <div>
          ...
          <p>
            ...
            to{' '}
            <a className={styles.ReleaseNotesLink} target="_blank" rel="noopener noreferrer" href={UNSUPPORTED_VERSION_URL}>
