...
export default function Tooltip({
  ...
  const updateTooltipPosition = (event: React.MouseEvent<any>) => {
  ...
  return <div className={styles.Container} onMouseMove={onMouseMove} ref={containerRef}>
      <div className={`${styles.Tooltip} ${tooltipClassName} ${className || ''}`} ref={tooltipRef} style={style}>
        {label}
      </div>
      {children}
    </div>;
...
function getMousePosition(relativeContainer, mouseEvent: React.MouseEvent<any>) {
