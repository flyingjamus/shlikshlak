...
function Profiler(_: {}) {
  ...
  const isRightColumnVisible = isLegacyProfilerSelected || enableProfilerComponentTree;
  let view = null;
      ...
      <div className={styles.Profiler}>
        <div className={styles.LeftColumn}>
          <div className={styles.Toolbar}>
            ...
            <TabBar currentTab={selectedTabID} id="Profiler" selectTab={selectTab} tabs={supportsTimeline ? tabsWithTimeline : tabs} type="profiler" />
            <RootSelector />
            <div className={styles.Spacer} />
            {!isLegacyProfilerSelected && <div ref={searchInputContainerRef} className={styles.TimelineSearchInputContainer} />}
            <SettingsModalContextToggle />
            {isLegacyProfilerSelected && didRecordCommits && <Fragment>
                <div className={styles.VRule} />
                <SnapshotSelector />
              </Fragment>}
          </div>
        ...
        {isRightColumnVisible && <div className={styles.RightColumn}>{sidebar}</div>}
        <SettingsModal />
      </div>
    </SettingsModalContextController>;
}

const OnlyTimelineData = () => <div className={styles.Column}>
...
const tabsWithTimeline = [...tabs, null, // Divider/separator
{
  id: 'timeline',
  icon: 'timeline',
  label: 'Timeline',
