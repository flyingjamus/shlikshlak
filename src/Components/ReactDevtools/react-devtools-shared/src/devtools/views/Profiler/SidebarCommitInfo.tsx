...
import styles from "./SidebarCommitInfo.module.css";
export type Props = {};
  ...
  return <Fragment>
      ...
      <div className={styles.Content}>
        <ul className={styles.List}>
          {priorityLevel !== null && <li className={styles.ListItem}>
          ...
          {!hasCommitPhaseDurations && <li className={styles.ListItem}>
          ...
          {updaters !== null && commitTree !== null && <li className={styles.ListItem}>
