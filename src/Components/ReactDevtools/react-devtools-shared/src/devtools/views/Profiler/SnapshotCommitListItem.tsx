...
import styles from "./SnapshotCommitListItem.module.css";
...
function SnapshotCommitListItem({
  ...
  return <div className={styles.Outer} onMouseDown={handleMouseDown} onMouseEnter={() => setHoveredCommitIndex(index)} style={{ ...style,
    width,
    borderBottom: isSelected ? '3px solid var(--color-tab-selected-border)' : undefined
  }}>
      <div className={isSelected ? styles.InnerSelected : styles.Inner} style={{
